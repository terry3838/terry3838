...
### "기술과 지혜가 만나는 곳에서, 자기 이해를 통한 지속 가능한 삶의 혁신"
...
```
엔지니어의 논리  +  인문학적 통찰  =  자기 이해의 새로운 길
```

- **현재 포지션**: 클라우드 인프라 전문가에서 Product Owner/PM으로 전환 중
- **비전**: 기술과 인문학적 통찰을 융합하여 사람들이 자신을 깊이 이해하고, 변화의 주체로 살아가도록 돕는 것
- **관심 분야**: AI 기반 자기이해 서비스, 프로덕트 매니지먼트, 명리학과 기술의 융합
- **성격**: 탐구적, 성찰적이며 동시에 현실적인 전략가
...
```
- B2B 클라우드 인프라 전문가
- AWS, GCP, OpenStack 아키텍트
- 금융/통신/제조 대기업 시스템 컨설팅
- Tech Leader & Team Manager
...
![Hybrid Cloud](https://img.shields.io/badge/Hybrid_Cloud-2c3e50?style=for-the-badge&logo=icloud&logoColor=white)
...
## <img src="https://media.giphy.com/media/3oriNZoNvn73MZaFYk/giphy.gif" width="25"> Key Achievements

<div align="center">

| 지표 | 성과 | 영역 |
|:---:|:---:|:---:|
| **+15%** | 고객 만족도 향상 | Customer Success |
| **99.99%** | 금융 서비스 가용성 | High Availability |
| **100%** | 클라우드 마이그레이션 성공률 | Cloud Migration |
| **-15%** | 연간 운영 비용 절감 | Cost Optimization |

</div>

<details>
<summary><b>주요 프로젝트 경험 펼쳐보기</b></summary>

<br>

- **금융권**: 메트라이프, 삼성증권, NH증권, 현대증권, 삼성SDS, 교보라이프플래닛
- **제조/유통**: 삼성전자, 르노자동차, SPC, 이랜드, 베네통
- **IT/통신**: SKT, 판도라TV, 코인제스트
- **역할**: Solution Architect, Technical Architect, Tech Leader, Technical Account Manager
...
[![Email](https://img.shields.io/badge/Email-terry.kim3838@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:terry.kim3838@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Terry_Kim-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/terry38-kim)
[![KakaoTalk](https://img.shields.io/badge/KakaoTalk-Open_Chat-FFCD00?style=for-the-badge&logo=kakaotalk&logoColor=3A1D1D)](https://open.kakao.com/o/s3ewaGIh)

<br>

![Message](https://img.shields.io/badge/언제든_편하게_연락주세요!-2c3e50?style=for-the-badge)
...
![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:3498db,100:2c3e50&height=120&section=footer)
